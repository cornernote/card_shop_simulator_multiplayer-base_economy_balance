...
"workshopitem"
{
    ...
    "description"      "Retunes base card values, pack rarity odds, rarity multipliers, and premium traits so opening packs feels better without replacing card art, card names, rarity, stats, elements, or pack placement."
    "changenote"       "version 0.7.0"
}
```
